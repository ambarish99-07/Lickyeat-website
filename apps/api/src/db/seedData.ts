...
export async function runSeed(opts: { wipe?: boolean } = {}) {
  ...
  await BrandModel.create([
    ...
    },
    {
      ...
      description: "Craft mocktails with the drama of a cocktail bar — layered, garnished, alcohol-free.",
      orderingModel: "catalog",
      status: "live",
      primaryColor: "#0f766e",
      accentColor: "#f4a259",
  ...
  await CouponModel.create([
    { code: "WELCOME50", kind: "flat", value: 50, minOrderAmount: 250, brandId: null, isActive: true },
    {
      code: "TBC20",
      kind: "percent",
      value: 20,
