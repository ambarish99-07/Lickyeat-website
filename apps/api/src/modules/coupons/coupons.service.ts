...
import { resolveCouponDiscount } from "@lickyeat/shared-types";
...
export async function resolveCouponForCart(
  code: string,
  ctx: { subtotal: number; brandId: string },
  ...
  return {
    ...
    message: `Coupon ${coupon.code} applied — you save ₹${result.discountAmount}.`,
  };
}
